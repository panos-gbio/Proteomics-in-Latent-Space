...
def test_set_analysis(
        ...
        active_func : bool, optional
            Informs whether the decoder output is transformed with an activation function (or there is no need for it). 
            If set True, then there will be no transformation to the output during. Default is True. 
            downstream analysis. If False, a sigmoid is used to transform the decoder output, x_mu. 
        ...
        if active_func:
            ...
            print("The decoder output will not be transformed during this analysis.")
            test_iter_dict = {
            "iteration": [],
            "Test total Loss": [],
            "Test KL Loss": [], 
